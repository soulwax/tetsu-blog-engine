...
Thanks for checking out my blog template. It's based on sveltekit, a server side rendered, statically built, minimalistic framework.
Since sveltekit 1.0 came out, I literally came buckets.
...
All of one's posts (including this one) are located in the `/posts` folder. They are written in markdown and parsed with mdsvex. If you're unfamiliar with mdsvex, I would recommend [looking at the website](https://mdsvex.com/playground) to see what is all possible out of the box. Those guys are amazing fr.
...
If you wish to change the theme of your code blocks, you can edit the `src/prism.css` file. Prism themes can be [found here](https://github.com/soulwax/tetsu-blog-engine).
...
```md
![Franz Ferdinand - Take Me Out](./franz-ferdinand_take-me-out.mp4)
```
